...
module ARM(
    ...
    output MemWrite,
    output [31:0] PC,
    // Renamed ALUResult to DPResult
    output [31:0] DPResult,
    ...
    // Declarations relevant for MCycle
    wire Start;
    wire [1:0] MCycleOp;
    wire [31:0]Operand1;
    wire [31:0] Operand2;
    ...
    // Replaced ALUResult with DPResult
    assign Result = MemtoReg == 1'b1 ? ReadData : DPResult;
    // Control Unit 
...
//    assign A3 = RegSrcMul[1] == 1'b1 ? Instr[19:16] : Instr[15:12];
    ...
    // Note that Result2 is discarded
    assign DPResult = DPControl ? Result1 : ALUResult;
    assign MULFlag = Instr[7:4];    
