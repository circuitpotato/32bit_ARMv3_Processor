...
MAIN
		...
		;AND R3, R2, R9				;It checks SW0 and SW1 on
		;CMP R3, R9			
		;BEQ BRANCHPREDICT
...
BRANCH5X
		;ADD R1, R1, R2
		SUBS R3, R3, R2
		BNE BRANCH5X				;BRANCH TO BRANCH5X 5 TIMES -BNE CHECK Z FLAG
		
		B SELECTBRANCH

BRANCH10X
		SUBS R4, R4, R2				;CAUSES LOOP 10X TO THIS BRANCH

SELECTBRANCH
		BMI BRANCHPREDICT			;BRANCH BACK TO START WHEN NEGATIVE FLAG SET MEANS LOOPED 10X COMPLETE
		BPL BRANCH10X				;BRANCH BACK TO BRACH10X TO CONTINUE THE LOOP - N FLAG NOT RAISED
